...
class ParserConfig:
    ...
    SHEET_CONFIGS: Dict[str, SheetParsingConfig] = {
        "auxDBC": SheetParsingConfig(
            header_row=1, drop_no_column=True, max_records=1, return_single_record=True
        ),
        "cycle": SheetParsingConfig(
            header_row=0, drop_no_column=False, max_records=1, return_single_record=True
        ),
        "idle": SheetParsingConfig(
            header_row=0, drop_no_column=True, max_records=1, return_single_record=True
        ),
